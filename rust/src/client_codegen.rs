...
import {{
  ...
  RpcCallBuilder,
  RpcRemoteError,
}} from "@oresoftware/api-docs/fluent-rpc";
import type {{
  RpcCallArgs,
  RpcContext,
  RpcJsonObject,
...
export {{ RpcCallBuilder, RpcRemoteError }};
export type {{ RpcCallArgs, RpcContext, RpcJsonObject, RpcOutcome }};
...
/**
 * Service-scoped adapter over the shared api-docs RPC runtime.
 *
 * All execution and builder semantics live in @oresoftware/api-docs. This
 * generated class contributes only the admitted operation set and endpoint.
 */
export class RpcClient extends OresRpcClient<RpcOperation> {{
  constructor(
    baseUrl: string,
    ...
    super({{
      baseUrl,
      rpcPath: RPC_HTTP_PATH,
      operations: Object.keys(RPC_OPERATIONS) as RpcOperation[],
      fetchImpl,
    }});
  }}
}}
