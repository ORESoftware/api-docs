...
// The independently authored RPC contracts, runtime adapters, evidence helpers,
// tests, and admission workflows are always part of the oracle closure. Rust
// source is added from the tracked repository inventory below so a new Rust
// oracle input cannot be omitted from either producer or verifier evidence.
