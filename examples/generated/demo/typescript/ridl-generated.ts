...
export const OPERATIONS: ReadonlyArray<OperationInfo> = [
  { key: "get_matter", path: "/v1/matters/{id}", methods: ["GET"], delivery: "direct" },
  { key: "walk_matter", path: "/v1/matters/{id}/walk", methods: ["POST"], delivery: "opto_sync_queued" },
  { key: "healthz", path: "/healthz", methods: ["GET"], delivery: "direct" },
] as const;
